...
// Class BlockyLuaCore.BlockyLuaPipelineCommandlet
// 0x0000 (0x0080 - 0x0080)
class UBlockyLuaPipelineCommandlet : public UCommandlet
{
public:
	...
	static UClass* StaticClass()
	{
        static UClass *pStaticClass = 0;
        if (!pStaticClass)
            pStaticClass = UObject::FindClass("Class BlockyLuaCore.BlockyLuaPipelineCommandlet");
		return pStaticClass;
	}
