...
public:
	...
	struct FScriptDelegate                             OnImagePickDetectEvent;                                   // 0x0B18(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData32[0x4];                                       // 0x0B10(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnVideoPickEvent;                                         // 0x0B28(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData33[0x4];                                       // 0x0B28(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnPermissionResultEvent;                                  // 0x0B38(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData34[0x4];                                       // 0x0B38(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
