...
// ScriptStruct Client.UIElemLayoutDetail
// 0x0028
...
// ScriptStruct Client.UIElemLayoutSimple
// 0x0018
struct FUIElemLayoutSimple
{
	struct FAnchors                                    Anchors;                                                  // 0x0000(0x0010) (Edit, BlueprintVisible)
	struct FVector2D                                   Offsets;                                                  // 0x0010(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
};

// ScriptStruct Client.TouchStatInfo
// 0x0008
