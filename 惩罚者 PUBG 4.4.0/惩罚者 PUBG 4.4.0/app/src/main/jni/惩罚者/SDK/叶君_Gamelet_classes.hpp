...
{
public:
	struct FScriptDelegate                             OnSDKMessage;                                             // 0x0028(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0028(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnRefreshUserdata;                                        // 0x0038(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0038(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnViewCreated;                                            // 0x0048(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0048(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnViewAboutToDestroy;                                     // 0x0058(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0058(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnReportData;                                             // 0x0068(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData04[0x4];                                       // 0x0068(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnProfileJSSDKMessage;                                    // 0x0078(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData05[0x4];                                       // 0x0078(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnPuertsCommonFuncDelegate;                               // 0x0088(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData06[0x4];                                       // 0x0088(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData07[0x2];                                       // 0x009E(0x0002) MISSED OFFSET
	struct FScriptDelegate                             OnCoreCodeLoad;                                           // 0x00A0(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData08[0x4];                                       // 0x009E(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
