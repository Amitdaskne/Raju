...
struct FVector
{
	...
	float                                              Z;                                                        // 0x0008(0x0004) (Edit, BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData)
        ...
        FORCEINLINE bool operator==(const FVector & src)const
        {
        ...
        FORCEINLINE float Distance(FVector PE_Result)
        {
        ...
        FORCEINLINE float Dot(const FVector & vOther) const
        {
...
struct FVector2D
{
	...
	float                                              Y;                                                        // 0x0004(0x0004) (Edit, BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData)
        ...
        FORCEINLINE bool operator==(const FVector2D & src)const
        {
		...
		FORCEINLINE float Distance(FVector2D PE_Result)
        {
        ...
        FORCEINLINE float Dot(const FVector2D & vOther) const
        {
            const FVector2D & a = *this;
              return (a.X * vOther.X + a.Y * vOther.Y);
        }

        FORCEINLINE FVector2D Normalize()
        {
            FVector2D vector;
            float length = this->Size();
