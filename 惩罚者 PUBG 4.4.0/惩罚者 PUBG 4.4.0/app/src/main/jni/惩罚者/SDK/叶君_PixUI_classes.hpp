...
{
public:
	struct FScriptDelegate                             DelegateActivateInput;                                    // 0x0028(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0028(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             DelegateDeactivateInput;                                  // 0x0038(0x000C) (Edit, ZeroConstructor, InstancedReference)
...
public:
	...
	struct FScriptDelegate                             DelegateOnExternalOpen;                                   // 0x0098(0x000C) (Edit, ZeroConstructor, InstancedReference)
	...
	struct FScriptDelegate                             DelegateOnConfirm;                                        // 0x00D8(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData01[0x4];                                       // 0x00D8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             DelegateOnPrompt;                                         // 0x00E8(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x4];                                       // 0x00E8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData03[0x4C];                                      // 0x011C(0x004C) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData01[0x24];                                      // 0x00EC(0x0024) MISSED OFFSET
...
{
public:
	struct FScriptDelegate                             PixUIWidgetOpenDelegate;                                  // 0x0260(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0260(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             PixUIWidgetConfirmDelegate;                               // 0x0270(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0270(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             PixUIWidgetPromptDelegate;                                // 0x0280(0x000C) (Edit, ZeroConstructor, InstancedReference)
...
public:
	...
	struct FScriptDelegate                             DelegateOnExternalOpen;                                   // 0x01A8(0x000C) (Edit, ZeroConstructor, InstancedReference)
	...
	struct FScriptDelegate                             DelegateOnConfirm;                                        // 0x01E8(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x4];                                       // 0x01E8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             DelegateOnPrompt;                                         // 0x01F8(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData03[0x4];                                       // 0x01F8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	struct FScriptDelegate                             DelegateHookKeyEvent;                                     // 0x0238(0x000C) (Edit, ZeroConstructor, InstancedReference)
	...
	unsigned char                                      UnknownData05[0x7];                                       // 0x0251(0x0007) MISSED OFFSET
	...
	unsigned char                                      UnknownData06[0xE2];                                      // 0x0276(0x00E2) MISSED OFFSET
